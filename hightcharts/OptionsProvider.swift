...
class OptionsProvider {
    ...
    class func provideOptions(forChartType options: [String: Any], series: [Any], type: String) -> HIOptions {
        ...
        if options["chartType"] as? String == "pie" {
            ...
            let chart = HIChart()
            chart.backgroundColor = HIColor(linearGradient: ["x1": 0, "y1": 0, "x2": 0, "y2": 300], stops: [[0, "rgb(180, 200, 235)"], [1, "rgb(200, 210, 255)"]])
            ...
            /*plotOptions.pie. fillColor = HIColor(linearGradient: ["x1": 0, "y1": 0, "x2": 0, "y2": 150], stops: [[0, "rgba(255,255,255, 0.75)"], [1, "rgba(255,255,255, 0.02)"]])*/
            ...
            tooltip.headerFormat = "{series.name}<br>"
        ...
        if options["chartType"] as? String == "area" {
            ...
            area.tooltip.valueSuffix = " \(options["unit"]!)"
            area.showInLegend = false
            area.data = series
            area.color = HIColor(rgb: 255, green: 255, blue: 255)
            area.name = options["title"] as! String
        ...
        if options["chartType"] as? String == "column" {
            ...
            column.tooltip.valueSuffix = " \(options["unit"]!)"
        ...
        if options["chartType"] as? String == "spline" {
            ...
            spline.tooltip.valueSuffix = " \(options["unit"]!)"//\(String(describing: options["unit"]))"
